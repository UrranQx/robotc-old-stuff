...
int gyroOffset,gyroRate,GyroRateOld=0,angVel,velocity=200;//100
...
{Reset_1();
	while(true)
	{
		...
		gyroOffset=gyroRate*0.0001+gyroOffset*0.9999;
		...
		errEnc=enc-path;
		u=angVel*3+ angle * 15 + errEnc * 0.1+ encVelSoft * 50 + iEnc*0.1;//angVel*2.8////angle*33///
