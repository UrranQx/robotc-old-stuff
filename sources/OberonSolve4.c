...
float wk=1,W=100;//40
int angle = 0;
float V1=30, green=3, mas[120], len=0,alpha=68,beta=-67;//84.5
int fd=1;
...
void Sync_forward()
{
	...
	while (nMotorEncoder[motorB]>-580)//old615
	{int u1,es1,es1old,k3=2,k4=2;
	if (sensorValue[S2]<15)
  {  es1=SensorValue[S2]-7;
