...
task motor2()
{float i2=0,e2,p2,d2,u2,k2=1,ki2=0.001,kp2=0.1,kd2=1,eold2=0;
	while (true)
...
task motor3()
{float i3=0,e3,p3,d3,u3,k3=1,ki3=0.001,kp3=0.1,kd3=1,eold3=0;
	while (true)
...
{nMotorEncoder[motorA]=0;
	...
	startTask(motor1);	startTask(motor2);startTask(motor3);
